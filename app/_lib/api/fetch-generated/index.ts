...
export type ListWorkoutPlans200ItemWorkoutDaysItemExercisesItemPhase =
  (typeof ListWorkoutPlans200ItemWorkoutDaysItemExercisesItemPhase)[keyof typeof ListWorkoutPlans200ItemWorkoutDaysItemExercisesItemPhase];

export const ListWorkoutPlans200ItemWorkoutDaysItemExercisesItemPhase = {
  WARMUP: "WARMUP",
  WORKOUT: "WORKOUT",
  COOLDOWN: "COOLDOWN",
} as const;
...
export type ListWorkoutPlans200ItemWorkoutDaysItemExercisesItem = {
  ...
  /** @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$ */
  workoutDayId: string;
  phase: ListWorkoutPlans200ItemWorkoutDaysItemExercisesItemPhase;
  sets: number;
  reps: number;
...
export type CreateWorkoutPlanBodyWorkoutDaysItemExercisesItemPhase =
  (typeof CreateWorkoutPlanBodyWorkoutDaysItemExercisesItemPhase)[keyof typeof CreateWorkoutPlanBodyWorkoutDaysItemExercisesItemPhase];

export const CreateWorkoutPlanBodyWorkoutDaysItemExercisesItemPhase = {
  WARMUP: "WARMUP",
  WORKOUT: "WORKOUT",
  COOLDOWN: "COOLDOWN",
} as const;
...
export type CreateWorkoutPlanBodyWorkoutDaysItemExercisesItem = {
  ...
  /** @minLength 1 */
  name: string;
  phase?: CreateWorkoutPlanBodyWorkoutDaysItemExercisesItemPhase;
  /** @minimum 1 */
  sets: number;
  /** @minimum 1 */
  reps: number;
...
export type CreateWorkoutPlan201WorkoutDaysItemExercisesItemPhase =
  (typeof CreateWorkoutPlan201WorkoutDaysItemExercisesItemPhase)[keyof typeof CreateWorkoutPlan201WorkoutDaysItemExercisesItemPhase];

export const CreateWorkoutPlan201WorkoutDaysItemExercisesItemPhase = {
  WARMUP: "WARMUP",
  WORKOUT: "WORKOUT",
  COOLDOWN: "COOLDOWN",
} as const;
...
export type CreateWorkoutPlan201WorkoutDaysItemExercisesItem = {
  ...
  /** @minLength 1 */
  name: string;
  phase: CreateWorkoutPlan201WorkoutDaysItemExercisesItemPhase;
  /** @minimum 1 */
  sets: number;
  /** @minimum 1 */
  reps: number;
...
export type GetWorkoutDayById200ExercisesItemPhase =
  (typeof GetWorkoutDayById200ExercisesItemPhase)[keyof typeof GetWorkoutDayById200ExercisesItemPhase];

export const GetWorkoutDayById200ExercisesItemPhase = {
  WARMUP: "WARMUP",
  WORKOUT: "WORKOUT",
  COOLDOWN: "COOLDOWN",
} as const;
...
export type GetWorkoutDayById200ExercisesItem = {
  ...
  /** @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$ */
  workoutDayId: string;
  phase: GetWorkoutDayById200ExercisesItemPhase;
  sets: number;
  reps: number;
  restTimeInSeconds: number;
};
...
export type getSwaggerJsonResponse200 = {
  data: void;
  status: 200;
};

export type getSwaggerJsonResponseSuccess = getSwaggerJsonResponse200 & {
  headers: Headers;
};
export type getSwaggerJsonResponse = getSwaggerJsonResponseSuccess;

export const getGetSwaggerJsonUrl = () => {
  return `/swagger.json`;
};

export const getSwaggerJson = async (
  options?: RequestInit,
): Promise<getSwaggerJsonResponse> => {
  return customFetch<getSwaggerJsonResponse>(getGetSwaggerJsonUrl(), {
    ...options,
    method: "GET",
  });
};
